 ...
 */
static void freeFileTimes(void)
{
 ...
 */
static void formatTime(time_t t, char* s)
{
	struct tm* tmp;
...
static int cmpNames(const void *va, const void *vb)
